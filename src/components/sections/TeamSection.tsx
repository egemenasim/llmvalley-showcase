...
const team = [
  {
    ...
    icon: '🎨',
    desc: 'Led game design decisions, overall system architecture, and feature planning. Implemented core gameplay systems and NPC mechanics.',
  ...
  },
  {
    ...
    icon: '🖌️',
    desc: 'Created the pixel-art assets, tilesets, and character sprites. Implemented 2D scene layout and visual consistency across all game screens.',
  ...
  },
  {
    ...
    role: 'Game Developer',
    icon: '💻',
    desc: 'Implemented the NPC dialogue system, OpenRouter API integration, relationship tracking, and conversation persistence across sessions.',
  ...
  },
  {
    ...
    role: 'Game Developer',
    icon: '⚙️',
    desc: 'Developed the farming, fishing, and economy systems. Implemented the inventory, wallet, save/load mechanics, and scene transitions.',
